...
本应用为**非官方第三方客户端**，与丝芭传媒（SNH48 Group）及口袋48官方无任何关联，未获得其授权或认可。

- 应用内的直播、视频、音乐、图片、文本等内容均来源于口袋48 官方公开接口，版权归权利人所有；
- 本项目仅供个人学习交流与技术研究使用，请勿用于商业用途；
- 使用本应用造成的一切后果（含账号风险）由使用者自行承担；
- 若内容涉及侵权，请联系仓库维护者删除相关内容。
